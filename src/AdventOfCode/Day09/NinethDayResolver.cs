...
{
    public class NinethDayResolver : IResolver
    {
        /*
...
Your puzzle answer was 69316178.
...
What is the encryption weakness in your XMAS-encrypted list of numbers?
        ...
        public void ResolveSecond()
        {
            ...
            var firstNonXmas = this.GetFirstNonXmasNumber(inputData);

            var numbers = inputData.Take(firstNonXmas.Position).ToArray();
            var elements = new ElementsFinder().GetElementsToAdd(firstNonXmas.Number, numbers);
        ...
        {
            return new NumberNonXmasFinder() { PreambleSize = 25 }.GetNumberNonXmas(inputData);
        }
